...
data object TaskDetailsScreen : FonamentUI<TaskDetailsUIState>() {
    override val content: FonamentContent<TaskDetailsUIState, *> = TaskDetailContent
}

@OptIn(ExperimentalWearFoundationApi::class)
internal data object TaskDetailContent : FonamentContent<TaskDetailsUIState, NoContentState>() {

    @Composable
    override fun createContentState(uiState: TaskDetailsUIState): NoContentState =
        NoContentState
