...
sealed interface TaskListTasksEvent : FonamentEvent {
    ...
    data object ShowDeleteTaskAlertDialog : TaskListTasksEvent

    data object ShowDeleteTaskListAlertDialog : TaskListTasksEvent

    data object CancelDeleteTaskAlertDialog : TaskListTasksEvent
