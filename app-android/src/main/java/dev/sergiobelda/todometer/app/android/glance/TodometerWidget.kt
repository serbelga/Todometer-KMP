...
package dev.sergiobelda.todometer.app.android.glance
...
import dev.sergiobelda.todometer.app.android.glance.theme.TodometerWidgetTheme
import dev.sergiobelda.todometer.app.android.ui.main.MainActivity
...
class TodometerWidget : GlanceAppWidget(), KoinComponent {
    ...
    companion object {
        private const val AddTaskDeepLink: String = "app://open.add.task"
        private const val TaskDetailsDeepLink: String = "app://open.task"
    }
}
