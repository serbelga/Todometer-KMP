...
fun homeNavigationEventHandler(
    ...
    FonamentNavigationEventHandler {
        when (it) {
            HomeNavigationEvent.NavigateToAddTaskList -> navigateToAddTaskList()
            HomeNavigationEvent.NavigateToEditTaskList -> navigateToEditTaskList()
            HomeNavigationEvent.NavigateToAddTask -> navigateToAddTask()
            is HomeNavigationEvent.NavigateToTaskDetails -> navigateToTaskDetails(it.taskId)
            HomeNavigationEvent.NavigateToSettings -> navigateToSettings()
            HomeNavigationEvent.NavigateToAbout -> navigateToAbout()
        }
    }
